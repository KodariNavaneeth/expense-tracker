...
def add_user(username, password):
    try:
        ...
        connector.commit()
        mb.showinfo('Success', 'User created successfully!')
...
def login():
    ...
    if verify_user(username, password):
        mb.showinfo('Success', 'Logged in successfully!')
...
def show_login_screen():
    ...
    Label(login_screen, text='Please enter your login details', font=('Arial', 14)).pack(pady=10)
    ...
    login_password = Entry(login_screen, show='*')
    login_password.pack()

    Button(login_screen, text='Login', command=login).pack(pady=10)
    Button(login_screen, text='Signup', command=show_signup_screen).pack()

    login_screen.mainloop()

def show_signup_screen():
    global signup_screen, signup_username, signup_password

    signup_screen = Tk()
    signup_screen.title('Signup')
    signup_screen.geometry('300x250')

    Label(signup_screen, text='Please enter your signup details', font=('Arial', 14)).pack(pady=10)
    ...
    signup_password = Entry(signup_screen, show='*')
    signup_password.pack()

    Button(signup_screen, text='Signup', command=signup).pack(pady=10)
...
def main_application():
    global desc, amnt, payee, MoP, date, table, data_entry_frame
